...
#ver1. = "AutoTrade에 종목선정필터 접목"
#ver2. = "10초마다 필터링 실행해서 동기화 하기",매수가 BID10



getcode = ["A005950","A267320","A124560","A005935","A102460","A055550","A024880","A179290","A067010","A046120","A267320","A080720","A042510","A038290"]
buycode = []
sellcode = []
buycodelist = []
buycodeset = []
...
def filtering():
    ...
    #buycodelist = list(set(buycode)) 
    #sellcodelist = list(set(sellcode)
   
#print("매수종목코드" + str(buycodelist))
#print("매도종목코드" + str(sellcodelist))

filtering()
symbol_list =str(buycodelist)
...
if __name__ == '__main__': 
    try:
        symbol_list = ["A005950","A267320","A124560","A005935","A102460","A055550","A024880","A179290","A067010","A046120","A267320","A080720","A042510","A038290"]
        ...
        while True:
            ...
            if t_start < t_now < t_sell :  # AM 09:05 ~ PM 03:15 : 매수
                ...
                if t_now.minute == 30 and 0 <= t_now.second <= 5: 
                    ...
                    time.sleep(5)
                filtering()
                buycodeset = set(buycode)
                buycodelist = list(buycodeset)
                #print(type(buycodelist))
                print("매수종목코드 :" + str(buycodelist))
                sellcodeset = set(sellcode)
                sellcodelist = list(sellcodeset)
                #print(type(sellcodelist))
                print("매도종족코드 :" + str(sellcodelist))
                #print(buycodelist)
                time.sleep(10)
